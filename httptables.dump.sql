...
--
-- Host: localhost    Database: httptables
-- ------------------------------------------------------
...
INSERT INTO `auth_permission` VALUES (1,'Can add log entry',1,'add_logentry'),(2,'Can change log entry',1,'change_logentry'),(3,'Can delete log entry',1,'delete_logentry'),(4,'Can add permission',2,'add_permission'),(5,'Can change permission',2,'change_permission'),(6,'Can delete permission',2,'delete_permission'),(7,'Can add group',3,'add_group'),(8,'Can change group',3,'change_group'),(9,'Can delete group',3,'delete_group'),(10,'Can add user',4,'add_user'),(11,'Can change user',4,'change_user'),(12,'Can delete user',4,'delete_user'),(13,'Can add content type',5,'add_contenttype'),(14,'Can change content type',5,'change_contenttype'),(15,'Can delete content type',5,'delete_contenttype'),(16,'Can add session',6,'add_session'),(17,'Can change session',6,'change_session'),(18,'Can delete session',6,'delete_session'),(19,'Can add rule',7,'add_rule'),(20,'Can change rule',7,'change_rule'),(21,'Can delete rule',7,'delete_rule'),(22,'Can add rule type',8,'add_ruletype'),(23,'Can change rule type',8,'change_ruletype'),(24,'Can delete rule type',8,'delete_ruletype'),(25,'Can add Token',9,'add_token'),(26,'Can change Token',9,'change_token'),(27,'Can delete Token',9,'delete_token');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(7,'app','rule'),(8,'app','ruletype'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(9,'authtoken','token'),(5,'contenttypes','contenttype'),(6,'sessions','session');
...
INSERT INTO `rule` VALUES (1,'device','device_1','/test/device','get',1470304637,1475246619,'reject','{\"status\":4003, \"message\":\"illegal device\"}',100,'apis.t.com'),(2,'user','user_1','/test/user','get',1470304637,1475246619,'reject','{\"status\":4002, \"message\":\"illegal user\"}',100,'apis.t.com'),(3,'origin','127.0.0.1','/test/origin','get',1470304637,1475246619,'reject','{\"status\":4001, \"message\":\"illegal origin\"}',100,'apis.t.com'),(4,'device','device_1','/test/device','get',1470304637,1475246619,'reject','{\"status\":4103, \"message\":\"illegal device\"}',100,'apis.z.com'),(5,'user','user_1','/test/user','get',1470304637,1475246619,'reject','{\"status\":4102, \"message\":\"illegal user\"}',100,'apis.z.com'),(6,'origin','127.0.0.1','/test/origin','get',1470304637,1475246619,'reject','{\"status\":4101, \"message\":\"illegal origin\"}',100,'apis.z.com');
